...
Feature: Editar usuário
        ...
        Scenario: Editar usuário com sucesso
            ...
            And o usuário tem pelo menos um usuário cadastrado
            And o usuário clica no botão de edição
            And o usuário visualizar o modal de edição
            And o usuário preencher os campos obrigatórios
            And o usuário clicar no botão "Salvar"
            Then o usuário visualizar uma mensagem de sucesso
            And o usuário visualizar o usuário editado na lista de usuários
        ...
        Scenario: Editar usuário com email já cadastrado
            ...
            And o usuário clicar no botão "Salvar"
            Then o usuário visualizar uma mensagem de erro de email já cadastrado
            And o usuário não conseguir editar o usuário
...
Feature: Excluir usuário
    ...
    Scenario: Excluir usuário com sucesso
        ...
        And o usuário tem pelo menos um usuário cadastrado
        And o usuário clica no botão de exclusão
        And o usuário visualizar o modal de exclusão
        And o usuário clicar no botão "Excluir"
        Then o usuário visualizar uma mensagem de sucesso
        And o usuário não visualizar o usuário excluído na lista de usuários
    ...
    Scenario: Excluir usuário com erro
        ...
        And o usuário clica no botão de exclusão
        And o usuário visualizar o modal de exclusão
        And o usuário clicar no botão "Cancelar"
        Then o usuário não visualizar uma mensagem de sucesso
        And o usuário visualizar o usuário na lista de usuários
